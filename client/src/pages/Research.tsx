  ...
  return (
    <div className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-6 group relative flex flex-col overflow-hidden bg-surface-container-lowest border border-outline-variant/20 hover:border-primary/20 transition-all duration-500">
          <div className="p-8 flex flex-col flex-grow">
            ...
            <p className="text-on-surface-variant font-body mb-8 max-w-2xl leading-relaxed">
          ...
          <div className="absolute top-4 right-4 text-primary/10 font-headline text-6xl italic select-none">
            01
          </div>
        </div>

        {/* Project 2: PersonaForge */}
        <div className="md:col-span-6 group flex flex-col bg-surface-container-low border border-outline-variant/10 hover:bg-surface-container-lowest transition-all duration-500">
          <div className="p-8 flex flex-col h-full">
            <div className="flex gap-2 mb-4">
              <span className="tag-accent">ACL 2026 Findings</span>
              <span className="tag-primary">Co-first Author</span>
            </div>
            <h3 className="font-headline text-2xl font-bold text-primary mb-1">PersonaForge</h3>
        ...
        <div className="md:col-span-6 group bg-primary p-8 md:p-12 text-on-primary relative overflow-hidden">
          <div className="relative z-10">
            ...
            <h3 className="font-headline text-3xl font-bold mb-4">ScrollWeaver</h3>
            <p className="text-primary-fixed leading-relaxed mb-8 max-w-md">
              Multi-agent social simulation environment that mimics complex human-digital
              interactions. Awarded 3rd place in the Soul AI Agent competition.
            </p>
            <a
              href="https://github.com/siruizou2005/ScrollWeaver"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 pb-1 border-b border-white/40 hover:border-white transition-colors text-sm font-medium"
            >
              View Demo Project
